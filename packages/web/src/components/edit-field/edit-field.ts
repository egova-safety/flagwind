...
export default class EditField extends Component
{
     ...
     * @returns string
     */
    protected get editComponentTag(): string | undefined
    {
     ...
     * @returns Vue
     */
    protected get editComponent(): Vue | undefined
    {
        return this.editComponentNode ? this.editComponentNode.componentInstance : undefined;
    }
    ...
    private validateComponent(): boolean
    {
        ...
        const editComponentTags = Object.keys(EditComponentTypes).map(key => (<any>EditComponentTypes)[key]);
