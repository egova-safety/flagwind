...
import { component, config, watch } from "../../decorators";
...
const removeClass = function(element: Element, name: string): void
{
...
const addClass = function(element: Element, name: string): void
{
...
export default class NumberCounter extends Component
{
    ...
    private addDigit(value: string, repeating: boolean = true): void
    {
        if(value === "-")
        {
            this.addSpacer(value, undefined, "fw-number-counter-negation-mark");
        ...
        if(value === ".")
        {
            this.addSpacer((this._format.radix || "."), undefined, "fw-number-counter-radix-mark");
